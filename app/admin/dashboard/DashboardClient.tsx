            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-6 space-y-4">
                ...
                {selectedQuestion.replies.map((reply) => (
                  ...
                  >
                    <div className="max-w-[80%] sm:max-w-[65%] bg-gradient-to-br from-jade-600 to-jade-700 rounded-2xl rounded-tr-sm px-4 py-3 shadow-lg">
                      <p className="text-white whitespace-pre-wrap break-words">
                        {reply.text}
                      </p>
                      <div className="flex items-center justify-end gap-1.5 mt-1.5">
                        <span className="text-[11px] text-jade-100/80">
                          {reply.adminUser.username} · {formatClock(reply.createdAt)}
                        </span>
